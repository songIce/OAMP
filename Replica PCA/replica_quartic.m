% This code is a rewrite of the code from https://github.com/fcamilli95/Structured-PCA.
% The notation has been preserved.

clear
clc

alphagrid=0.6:0.01:0.9;
prior = "Rad"; % 'Rad': Rademacher; 'Gauss'; 'sparse': 
r = 0.05; % sparsity
