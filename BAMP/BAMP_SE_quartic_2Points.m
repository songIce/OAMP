...
% This code is about two points prior distributions:
% alpha1^2 * delta(1/alpha1) + (1 - alpha1^2) * delta(0)
...
% freecum_data = load("../data/freecumulants_u0.mat"); %load a file containing the free cumulants you need
