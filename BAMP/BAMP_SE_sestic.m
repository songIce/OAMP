...
% This script implements the Bayes-optimal AMP (BAMP) for the sestic
...
% This code is about Rademancher prior distributions
...
alphagrid = 2.5 : 0.01 : 3;
%alphagrid = 2.3 : 0.3 : 3.8;
alphagrid = 2.2;
PCA_init = "T";
niter = 10;

omega = 0.1; % correlation of initialization
